...
for i in range(20, 32):
    ...
    # Reference is now 20dB
    caput(RFsp, 20, repeat_value=True, wait=True, timeout=10)
...
# Create a range for the plotting X-axis (20 to 31)
dB_range = range(20, 32)
...
for j in range(0, N):
    ...
    plt.subplot(2, 1, 1)
    # Using [20:] slice and dB_range for correct alignment
    plt.plot(dB_range, X1[j][20:], "-o", label="Beam without Correction")
    plt.plot(dB_range, X2[j][20:], "-o", label="Correction Prediction")
    plt.plot(dB_range, X3[j][20:], "-o", label="Beam with Correction")
    plt.plot(dB_range, X4[j][20:], "-o", label="Beam with old SG Table")
    ...
    plt.subplot(2, 1, 2)
    plt.plot(dB_range, Y1[j][20:], "-o", label="Beam without Correction")
    plt.plot(dB_range, Y2[j][20:], "-o", label="Correction Prediction")
    plt.plot(dB_range, Y3[j][20:], "-o", label="Beam with Correction")
    plt.plot(dB_range, Y4[j][20:], "-o", label="Beam with old SG Table")
    plt.grid(True)
    plt.xlabel("Attenuation (dB)")
